...
export class WorldAtmosphere {
  ...
  update(position,time,dt) {
    ...
    const intensity=snow*.8+ash*.35+sand*.32;
    ...
    this.uniforms.kind.value=snow>.45?0:1;this.uniforms.pixelScale.value=world.renderer.getPixelRatio();
    this.uniforms.color.value.set(snow>.45?'#eaf2ff':ash>.45?'#d39b7b':'#e2c799');
