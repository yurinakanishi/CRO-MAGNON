...
export const PC_HELP: readonly HelpCard[] = [
  ...
  },
  {
    ...
    note: 'M の地図で焚き火へワープ。場所を押し「ここへ行こう」でピンを共有。メニューからキャラクター変更。Tab 長押しでもちもの、G で手をふる、H で操作説明。',
  },
];
...
export const PAD_HELP: readonly HelpCard[] = [
  ...
  },
  {
    key: 'OPTIONS',
    title: 'メニュー',
    note: '今いる場所でキャラクターを変更できます。項目は十字キーか左スティックで選び、×○□△のどれでも決定。',
  },
  {
    key: 'タッチパッド / SHARE',
    title: '地図',
    note: '地図の炎を選んでワープ。矢印で地図を動かし「中央にピンを打つ」→「ここへ行こう」で仲間に共有。文字入力はキーボード。',
  },
];
