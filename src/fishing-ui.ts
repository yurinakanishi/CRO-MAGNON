...
export function installFishingUI({ player, state, available, action, openModal }) {
  let signature = '';
  function open() {
    signature = '';
    openModal(
