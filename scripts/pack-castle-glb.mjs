...
const root='output/model-generation/models/valley-castle',source=`${root}/work/low-poly/candidate-05/candidate.glb`,out=`${root}/work/low-poly/candidate-06`;
