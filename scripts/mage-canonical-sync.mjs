...
const sync=createModelSync('floppy-ear-mage'),file='assets/floppy-ear-mage-canonical-plan.json';
...
if(mode==='copy')await writeFile('assets/floppy-ear-mage-canonical-qa.json',JSON.stringify(result,null,2)+'\n',{flag:'wx'});
