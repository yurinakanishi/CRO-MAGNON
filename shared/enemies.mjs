...
const eligiblePlayer = (room, player, now) => player && !player.downedUntil && now >= (player.invulnerableUntil || 0) && combatDistance(player, room.camp || CAMP) > ENEMY_RULES.campSafeRadius;
