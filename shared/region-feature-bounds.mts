...
export const REGION_FEATURE_BOUNDS = Object.freeze({
  'desert-cactus': {
    ...
    method:
      'Every exact GLB triangle projected into XZ cells using separating axes; merged only across adjacent cells of equal conservative height.',
    cellSize: 0.25,
    maximumHorizontalOverestimateMetres: 0.3535533905932738,
    bounds: {
      min: [-0.26156508922576904, 0.0003228260320611298, -0.618472695350647],
      max: [0.26193928718566895, 2.4000654220581055, 0.6181135177612305],
    },
    occupiedCells: 15,
    boxes: [
      {
    ...
    limitations:
      'Conservative full silhouette collision; no under-arm passage or climbing physics.',
  },
  'volcanic-basalt-columns': {
    ...
    source:
      'output/model-generation/models/volcanic-basalt-columns/work/low-poly/candidate-01/candidate.glb',
    method:
      'Every exact GLB triangle projected into XZ cells using separating axes; merged only across adjacent cells of equal conservative height.',
    cellSize: 0.5,
    maximumHorizontalOverestimateMetres: 0.7071067811865476,
    bounds: {
      min: [-1.9320671558380127, -0.0026331578847020864, -1.9733924865722656],
      max: [1.9274166822433472, 4.599268913269043, 1.9806773662567139],
    },
    occupiedCells: 58,
    boxes: [
      {
