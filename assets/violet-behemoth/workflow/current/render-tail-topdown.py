...
args=sys.argv[sys.argv.index('--')+1:];revision=args[0];out=Path(args[1]);out.mkdir(parents=True,exist_ok=True)
...
plan={'TailSpin':[0,6,10,13,16,20,24,28,33,36,40,45],'Walk_Loop':[0,5,9,14,18,23,27,32],'Run_Loop':[0,3,6,9,12,15,18,21]}
