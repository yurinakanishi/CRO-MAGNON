...
source=M/'work/low-poly/revision-01/candidate.glb';out=M/'work/low-poly/revision-03';out.mkdir(parents=True,exist_ok=True);assert not (out/'candidate.glb').exists()
