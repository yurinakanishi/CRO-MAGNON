...
scene = bpy.context.scene; scene.render.engine = 'BLENDER_EEVEE'; scene.render.resolution_x = 640; scene.render.resolution_y = 480
...
for name, d in {'left': (-1, 0, .15), 'front': (0, -1, .15), 'threequarter': (-.8, -1, .35), 'top': (0, -.01, 1)}.items():
