...
def main():
    ...
    try:
        ...
        write(source.with_suffix('.json'),{'generator':'Codex built-in imagegen','prompt':prompt_file.read_text(encoding='utf-8').strip(),
              ...
              'author':'Codex','claude_used':False})
        ...
        write(dense.with_suffix('.json'),{'author':'Codex','claude_used':False,'seed':args.seed,'resolution':resolution,'texture_resolution':texture_resolution,
