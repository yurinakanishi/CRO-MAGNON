...
test('crafting, trading, and regeneration enforce resource costs and proximity', async (t) => {
  ...
  assert.deepEqual(player.inventory, { wood: 2, stone: 0, berry: 0, rawMeat: 0, cookedMeat: 0, obsidian: 0, seed: 0, water: 0 });
  player.lastAction = 0;
  ...
  assert.deepEqual(player.inventory, { wood: 0, stone: 0, berry: 3, rawMeat: 0, cookedMeat: 0, obsidian: 0, seed: 0, water: 0 });
