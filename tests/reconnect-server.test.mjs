...
test('a transient disconnect restores identity, position, inventory and the sole-player room',async t=>{
  ...
  assert.deepEqual(p.inventory,{wood:8,stone:3,berry:0,rawMeat:2,cookedMeat:0,obsidian:0,seed:0,water:0,rawFish: 0, cookedFish: 0, rawShellfish: 0, cookedShellfish: 0, shells: 0, obsidianBlade:0,rootSeed:0,herbSeed:0,rawRoot:0,herb:0,cookedRoot:0,herbRoot:0 });
