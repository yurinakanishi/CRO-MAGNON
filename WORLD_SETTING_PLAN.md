...
Later increments are tracked separately: [fishing](FISHING_PLAN.md), [shellfish, middens and obsidian spears](COASTAL_CRAFT_PLAN.md), [eight named residents with daily routines and help requests](VILLAGE_LIFE_PLAN.md), and [two additional fictional crops with hearth cooking](CROP_EXPANSION_PLAN.md). The residents' names, dialogue, daily exchanges and year-round presence are authored fantasy. Fire-root grass and aromatic grass are invented plants using existing grass models for their above-ground leaves, with distinct water, growth and food uses. All countries can grow every crop. Authored maritime weather, currents and route advice are implemented in [WEATHER_CURRENT_PLAN.md](WEATHER_CURRENT_PLAN.md). [Household journeys and temporary stays](HOUSEHOLD_JOURNEYS_PLAN.md) allow each country's two residents to be helped to travel on foot to Many Hearths, stay for two game days and return. These household groupings, gifts and schedules are fiction, without an assertion of kinship or marriage.

[Shared food pantries](SHARED_PANTRY_PLAN.md) now connect players' harvests and cooked foods with travel supplies, daily help and gathering contributions. The four existing hearths have separate, initially empty stocks; anyone may donate, and each player may receive three items per game day across all four places. The six accepted foods retain their existing uses. The capacities, daily allotments and unlimited shelf life are authored rules, not evidence of Paleolithic warehouses or rationing. This adds player-managed sharing; permanent migration, population growth, wider politics and long-term food simulation remain separate work.

[Face-to-face barter at Many Hearths](BARTER_PLAN.md) adds a reason for players to carry obsidian, unattached blades, food and seeds back to the gathering place. Two nearby players each offer one item type and agree to the same quantities before either inventory changes. Any changed offer revokes both consents; leaving or disconnecting cancels unfinished agreements without taking items. The nineteen eligible items retain their existing uses, and exchanging them does not award gathering credit or change pantry allowances. The place, quantities, time limit and consent rules are authored social design, not a recovered Paleolithic trading institution. Nonlocal archaeological objects can also reflect direct procurement, travel, gifts and other transfers.

[Resident suppers](RESIDENT_SUPPER_PLAN.md) connect player-supplied food to the eight residents' evening routines. Players explicitly set aside food within the existing pantry capacity; residents eat only these portions, once per game day after reaching the main or smaller gathering hearth. Visiting households eat at their current settlement, and leftover portions can return to common stock. Shellfish meals leave collectible shells for the existing middens. This optional shared meal does not model all subsistence, impose starvation or automate harvesting. Its scheduling, portion sizes, food selection and shell collection are authored fantasy; population changes, food spoilage and a complete long-term food economy remain separate work.
